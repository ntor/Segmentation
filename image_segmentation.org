...
- [-] Implement an artifical data-generator
  + [X] Class wrapper, polygons, ellipses, noise
  + [X] Way for sharing data (database?)
  + [ ] Random smooth curves
  + [ ] Dataloader Framework (perhaps with random transformations?)
- [X] Implement a global segmentation algorithm
